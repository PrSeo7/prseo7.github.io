...
Premium is a one-time, non-consumable purchase: no subscription, no trial, no recurring charge. It removes ads and unlocks all content and features. Your premium status is stored on your device and verified with the store; if the store cannot confirm it (for example offline), Premium is kept for a 7-day grace period. "Restore Purchases" in Settings recognizes a purchase made on another device or before a reinstall.
